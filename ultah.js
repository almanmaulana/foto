function initengahan(){
  ...
  new TypeIt("#kalimat", {
    ...
    afterComplete: async function(){
      // Tampilkan tombol lanjut seperti biasa
      aktiopsL();

      // 🎁 Foto kejutan muncul setelah teks diketik
      await Swal.fire({
        title: "Eh bentar...",
        text: "Ada yang mau aku kasih lihat dulu nih 😆",
        imageUrl: "https://raw.githubusercontent.com/almanmaulana/foto/refs/heads/main/ini.png", // ⬅️ GANTI link foto di sini
        imageWidth: 300,
        imageHeight: 300,
        imageAlt: "Foto Kejutan",
